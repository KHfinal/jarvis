                  ...
                  <form class="form" action="${path }/myinfoUpdate.do" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
	            			...
	            			<input type="text" required class="form-control" name="memberName" value="${memberLoggedIn.memberName }" placeholder=""/> 
	            		</div>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
	            			...
	            			<input type="tel" required  name="phone" id="phone" maxlength="11" class="form-control" pattern=".{11,}" value="${memberLoggedIn.phone }" placeholder=""/>
                          </div>
                      </div>
                       ...
                       <div class="form-group">
                          <div class="col-xs-6">
                              <label class="text-secondary">생년월일 </label>
		                       <input class="form-control" type="date" max="2020-12-31" min="1900-01-01" autocomplete="off" required  name="memberBirthday" value="${memberLoggedIn.memberBirthday}" placeholder="">
                          </div>
                      </div>
