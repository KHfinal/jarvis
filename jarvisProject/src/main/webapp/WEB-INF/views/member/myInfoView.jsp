                  ...
                  <form class="form" action="#" method="post" id="registrationForm">
                     ...
                     <div class="form-group">
                          <div class="col-xs-6">
	            			...
	            			<input type="text" required class="form-control" name="memberName" readonly="readonly" placeholder="${memberLoggedIn.memberEmail }"/> 
	            		</div>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
	            			...
	            			<input type="text" required class="form-control" name="memberName" readonly="readonly" value="${memberLoggedIn.memberName }" placeholder=""/> 
	            		</div>
                          </div>
                      </div>
